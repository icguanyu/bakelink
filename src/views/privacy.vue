  ...
  <div class="doc-wrap">
    ...
    <main class="doc-main">
      <div class="doc-inner">
        ...
        <p>鋪樂（以下簡稱「本服務」、「我們」）非常重視您的隱私。本隱私權政策說明我們如何蒐集、使用及保護您的個人資料。使用本服務即表示您同意本政策之內容。</p>
        ...
        <ul>
          <li><strong>服務維運需要</strong>：我們使用 Google Cloud（雲端運算與資料庫托管）來運作本服務。這些服務商僅依我們的指示處理資料，且受合約保護。</li>
          <li><strong>法律要求</strong>：依法院命令或政府主管機關的合法要求予以揭露。</li>
          <li><strong>保護權益</strong>：為防止詐欺或保護本服務及使用者的安全。</li>
        </ul>
        <p>請注意，客人的訂單資料會提供給該訂單所屬的店家，此為本服務運作之必要。</p>

        <h2>四、金流聲明</h2>
        <p>鋪樂平台<strong>不處理任何付款交易</strong>。所有款項往來均直接在店家與客人之間進行，本服務不涉及，亦不儲存任何信用卡或金融帳戶資訊。</p>

        <h2>五、資料保存期限</h2>
        <ul>
          <li>店家帳號資料：帳號存續期間，及刪除帳號後 30 天內（供備份回復用）</li>
          <li>訂單資料：訂單成立後保存 2 年</li>
          <li>系統日誌：90 天</li>
        </ul>
        ...
        <h2>八、未成年人</h2>
        <p>本服務不針對 13 歲以下兒童。如發現誤收兒童個資，我們將立即刪除。</p>
